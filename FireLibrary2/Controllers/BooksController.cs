...
namespace FireLibrary2.Controllers
{
    ...
    public class BooksController : ControllerBase
    {
        ...
        public async Task<ActionResult<List<BookDTO>>> GetBooks()
        {
            ...
            //BookDTO book1 = new BookDTO("1785034677", "The Martian", "Ebury Publishing", "English", 171, 2, "Andy Weir", "So you want to lieve on Mars. Perhaps its the rugged terrain, beutiful scenery, or vast..", "Six days ago, astronaut Mark Watney became one of the fist people to walk on Mars", 5, 5);
